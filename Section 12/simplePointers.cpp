...
int main() {
    ...
    std::cout << "sizeof of num is: " << sizeof num << " bytes" << std::endl;
    std::cout << "Address of num is: " << &num << std::endl; 	

    int *p; //declaring p to be a pointer to an integer
    ...
    int *score_ptr {nullptr}; //score_ptr is pointing at an integer but its storage is pointed nowhere
